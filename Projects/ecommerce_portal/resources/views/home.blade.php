    ...
    <div id="carouselExampleIndicators" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{asset('build/assets/images/slider1.png')}}" class="d-block w-100" alt="Slider 1">
            </div>
            <div class="carousel-item">
                <img src="{{asset('build/assets/images/slider2.png')}}" class="d-block w-100" alt="Slider 2">
            </div>
            <div class="carousel-item">
                <img src="{{asset('build/assets/images/slider3.png')}}" class="d-block w-100" alt="Slider 3">
            </div>
        </div>
            ...
            <div class="row theme-product">
                <div class="col-lg-3">
                    <div class="card">
                     ...
                     <a href="#"><img src="{{asset('build/assets/images/products/1.jpg')}}" class="card-img-top" alt="..."></a>
                        <div class="card-body">
                ...
                <div class="col-lg-3">
                    <div class="card">
                        ...
                        <a href="#"><img src="{{asset('build/assets/images/products/2.jpg')}}" class="card-img-top" alt="..."></a>
                        <div class="card-body">
                ...
                <div class="col-lg-3">
                    <div class="card">
                        ...
                        <a href="#"><img src="{{asset('build/assets/images/products/3.jpg')}}" class="card-img-top" alt="..."></a>
                        <div class="card-body">
                ...
                <div class="col-lg-3">
                    <div class="card">
                        ...
                        <a href="#"><img src="{{asset('build/assets/images/products/4.jpg')}}" class="card-img-top" alt="..."></a>
                        <div class="card-body">
            ...
            <div class="row theme-product">
                <div class="col-lg-3">
                    <div class="card">
                        ...
                        <a href="#"><img src="{{asset('build/assets/images/products/9.jpg')}}" class="card-img-top" alt="..."></a>
                        <div class="card-body">
