...
<head>
    ...
    <link href="<?php echo e(asset('build/assets/css/style.css')); ?>" rel="stylesheet">
</head>
<body>

<nav class="navbar navbar-expand-lg theme-navbar">
    <div class="container">
        <a class="navbar-brand text-light" href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('build/assets/images/logo/logo.png')); ?>" style="width:250px"></a>
...
<nav class="navbar navbar-expand-lg theme-navbar-light">
    <div class="container-fluid">
        <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
            <ul class="nav">
                <li class="nav-item ">
                    <a class="nav-link active text-dark" href="<?php echo e(url('category/electronics')); ?>">Mobile</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link active text-dark" href="<?php echo e(url('category/electronics/tv')); ?>">Applinces</a>
                </li>
            </ul>
        </div>
    </div>
</nav>
<?php /**PATH /home/rashed/Desktop/Laravel/Projects/ecommerce_portal/resources/views/layouts/header.blade.php ENDPATH**/ ?>