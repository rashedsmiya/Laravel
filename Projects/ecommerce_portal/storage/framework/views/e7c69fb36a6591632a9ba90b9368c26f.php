    ...
    <div id="carouselExampleIndicators" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="<?php echo e(asset('build/assets/images/slider1.png')); ?>" class="d-block w-100" alt="Slider 1">
            </div>
            <div class="carousel-item">
                <img src="<?php echo e(asset('build/assets/images/slider2.png')); ?>" class="d-block w-100" alt="Slider 2">
            </div>
            <div class="carousel-item">
                <img src="<?php echo e(asset('build/assets/images/slider3.png')); ?>" class="d-block w-100" alt="Slider 3">
            </div>
        </div>
    ...
    <section class="my-5">
        <div class="container">
            ...
            <div class="d-flex">
                ...
                <div class="p-2"><a href="#" class="btn btn-sm theme-green-btn text-light">View All</a></div>
            ...
            <div class="row theme-product">
                <div class="col-lg-3">
                    <div class="card">
                     ...
                     <a href="#"><img src="<?php echo e(asset('build/assets/images/products/1.jpg')); ?>" class="card-img-top" alt="..."></a>
                        <div class="card-body">
                ...
                <div class="col-lg-3">
                    <div class="card">
                        ...
                        <a href="#"><img src="<?php echo e(asset('build/assets/images/products/2.jpg')); ?>" class="card-img-top" alt="..."></a>
                        <div class="card-body">
                ...
                <div class="col-lg-3">
                    <div class="card">
                        ...
                        <a href="#"><img src="<?php echo e(asset('build/assets/images/products/3.jpg')); ?>" class="card-img-top" alt="..."></a>
                        <div class="card-body">
                ...
                <div class="col-lg-3">
                    <div class="card">
                        ...
                        <a href="#"><img src="<?php echo e(asset('build/assets/images/products/4.jpg')); ?>" class="card-img-top" alt="..."></a>
                        <div class="card-body">
                            <h6 class="card-title text-center"><a href="#" class="text-dark text-decoration-none">Wooden Chair Shoes</a></h6>
            ...
            <div class="row theme-product">
                <div class="col-lg-3">
                    <div class="card">
                        ...
                        <a href="#"><img src="<?php echo e(asset('build/assets/images/products/9.jpg')); ?>" class="card-img-top" alt="..."></a>
                        <div class="card-body">
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/rashed/Desktop/Laravel/Projects/ecommerce_portal/resources/views/home.blade.php ENDPATH**/ ?>